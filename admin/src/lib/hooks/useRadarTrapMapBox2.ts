...
import { useRadarTrapSource2 } from "./useRadarTrapSource2";

const cache = new Map();

const useRadarTrapMapBox2 = (id: null | string, feathersClient: radarTrap.FeathersClient) => {
	...
	const {
		...
		areaSourceStatus,
		routeSourceStatus,
	} = useRadarTrapSource2(id, feathersClient);
