...
var prepareTraps_exports = {};
__export(prepareTraps_exports, {
  prepareTraps: () => prepareTraps
});
module.exports = __toCommonJS(prepareTraps_exports);
function isArray(it) {
...
const prepareTraps = (traps) => Object.values(traps).reduce((list, t) => {
  if (isArray(t)) {
    ...
    const lineTraps = t.filter((obj) => {
      var _a;
      return ((_a = obj.properties) == null ? void 0 : _a.polyline) !== "";
    }).map((obj) => {
      var _a;
      const lt = (_a = obj.properties) == null ? void 0 : _a.polyline;
...
//# sourceMappingURL=prepareTraps.js.map
